...
describe('Converter: Cypress validation', () => {
  [
    ...
    createOption('should("contain.text", "a text message")', 'toContainText("a text message")'),
  ...
  [
    ...
    createOption('should("not.contain.text", "a text message")', 'toContainText("a text message")'),
